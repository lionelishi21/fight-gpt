 ...
 */
export class CharacterEncyclopediaController
  extends BaseController
  implements ICharacterEncyclopediaController
{
  constructor(
   ...
   */
  async createEncyclopedia(req: Request, res: Response, next: NextFunction): Promise<void> {
   ...
   */
  async getEncyclopediaById(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
   ...
   */
  async getEncyclopediaByGameAndCharacter(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
    ...
    try {
      ...
      const result = await this.characterEncyclopediaService.getEncyclopediaByGameAndCharacter(
        gameId,
        characterId
      );
   ...
   */
  async getCurrentEncyclopedia(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
    ...
    try {
      ...
      const result = await this.characterEncyclopediaService.getCurrentEncyclopediaByGameAndCharacter(
        gameId,
        characterId
      );
   ...
   */
  async getEncyclopediasByGame(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
   ...
   */
  async getGameRules(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
   ...
   */
  async updateEncyclopedia(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();

    try {
      const { id } = req.params;
      const request: UpdateCharacterEncyclopediaRequest = req.body;
   ...
   */
  async updateEncyclopediaByGameAndCharacter(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
    ...
    try {
      ...
      const result = await this.characterEncyclopediaService.updateEncyclopediaByGameAndCharacter(
        gameId,
        characterId,
        request
      );
   ...
   */
  async deleteEncyclopedia(req: Request, res: Response, next: NextFunction): Promise<void> {
    const requestId = this.getRequestId(req);
    const startTime = Date.now();
