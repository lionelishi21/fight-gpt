...
export class GameService extends BaseService implements IGameService {
   ...
   * Create new game
   */
  async createGame(request: CreateGameRequest): Promise<ApiResponse<IGame>> {
    try {
   ...
   */
  async getGameById(id: string): Promise<ApiResponse<IGame>> {
    try {
   ...
   * Get game by game_id
   */
  async getGameByGameId(gameId: string): Promise<ApiResponse<IGame>> {
    try {
   ...
   */
  async updateGame(id: string, request: UpdateGameRequest): Promise<ApiResponse<IGame>> {
    try {
   ...
   * Delete game
   */
  async deleteGame(id: string): Promise<ApiResponse<boolean>> {
    try {
      const game = await this.gameRepository.findById(id);
   ...
   */
  async getActiveGames(): Promise<ApiResponse<IGame[]>> {
    try {
   ...
   */
  async findGames(filters: GameFilters, limit?: number): Promise<ApiResponse<IGame[]>> {
    try {
   ...
   * Search games
   */
  async searchGames(query: string): Promise<ApiResponse<IGame[]>> {
    try {
   ...
   * Activate game
   */
  async activateGame(id: string): Promise<ApiResponse<IGame>> {
    try {
   ...
   * Deactivate game
   */
  async deactivateGame(id: string): Promise<ApiResponse<IGame>> {
    try {
   ...
   */
  async refreshCharacterCount(gameId: string): Promise<ApiResponse<IGame>> {
    try {
      const game = await this.gameRepository.findByGameId(gameId);
   ...
   */
  private validateCreateRequest(request: CreateGameRequest): void {
   ...
   */
  private mapToGame(document: IGameDocument): IGame {
    return {
