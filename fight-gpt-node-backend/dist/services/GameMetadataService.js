 ...
 */
class GameMetadataService extends BaseService_1.BaseService {
    gameMetadataRepository;
    constructor(gameMetadataRepository) {
        super();
     ...
     */
    async createGameMetadata(request) {
        try {
     ...
     */
    async getGameMetadataByGameId(gameId) {
        try {
     ...
     */
    async getCurrentGameMetadataByGameId(gameId) {
        try {
     ...
     */
    async updateGameMetadata(id, request) {
        try {
     ...
     */
    async updateGameMetadataByGameId(gameId, request) {
        try {
