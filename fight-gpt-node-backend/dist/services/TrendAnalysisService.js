...
class TrendAnalysisService {
    ...
    notificationService;
    gameMetadataService;
    constructor(analysisRepository, notificationService, gameMetadataService) {
    ...
    async analyzeMetaShifts() {
        ...
        for (const game of games) {
            ...
            recentAnalyses.forEach(a => {
                ...
                if (p1)
                    charCounts[p1] = (charCounts[p1] || 0) + 1;
                if (p2)
                    charCounts[p2] = (charCounts[p2] || 0) + 1;
            });
            ...
            if (frequency > 25) {
                ...
                await this.notificationService.broadcast('META_SHIFT', {
