...
const UserGameSchema = new mongoose_1.Schema({
    user: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    game: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Game', required: true },
    character: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Character' },
    planType: {
        type: String,
        enum: ['free', 'premium'],
        default: 'free',
...
exports.default = mongoose_1.default.model('UserGame', UserGameSchema);
