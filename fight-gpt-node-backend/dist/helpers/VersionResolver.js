...
`
     ...
     */
    static resolvePrompt(version = 'v1') {
     ...
     */
    static resolvePromptForFormat(matchFormat = '1v1', p1Team, p2Team) {
        ...
        return teamHeader ? baseTeamPrompt.replace('This is a TEAM match.', `This is a TEAM match.${teamHeader}`) : baseTeamPrompt;
    }
    /**
